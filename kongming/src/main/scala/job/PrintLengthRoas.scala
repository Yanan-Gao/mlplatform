...
object PrintLengthRoas extends KongmingBaseJob {

  override def jobName: String = "PrintLengthRoas"
  ...
  def testReadRange(
    ...
    val datasets = Seq(
      ...
      ("DailyExchangeRateDataset", () => DailyExchangeRateDataset(), false)
    )
  ...
  def testReadDate(date: LocalDate): Array[(String, Long)] = {
    ...
    val datasets = Seq(
      ...
      ("DailyExchangeRateDataset", () => DailyExchangeRateDataset())
    )
