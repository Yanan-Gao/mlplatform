...
case class IntermediateTrainDataWithFeatureDataset(split:String, experimentOverride: Option[String]=None) extends PartitionedS3DataSet2[DataForModelTrainingRecord, LocalDate, String, LocalDate, String](
  GeneratedDataSet,
  MLPlatformS3Root,
