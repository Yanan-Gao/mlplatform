...
package com.ttd.contextual.util.elDoradoUtilities.streaming.records.rtb.bidrequest

import com.ttd.contextual.util.elDoradoUtilities.streaming.records.rtb.{DataUsageRecord, DeviceTypeLookupRecord, Uuid}
import com.ttd.contextual.util.elDoradoUtilities.streaming.records.rtb.{DataUsageRecord, DeviceTypeLookupRecord, RenderingContextLookupRecord, Uuid}
