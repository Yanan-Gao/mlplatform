package com.ttd.ml.features.web.urlprofile.workflows

import java.time.LocalDate

import com.swoop.alchemy.spark.expressions.hll.functions.hll_init_agg
import com.ttd.ml.datasets.generated.contextual.web.urlprofile.{AvailsTrafficCount, AvailsTrafficCountRecord}
import com.ttd.ml.util.elDoradoUtilities.datasets.sources.Avails7DayDataSet
