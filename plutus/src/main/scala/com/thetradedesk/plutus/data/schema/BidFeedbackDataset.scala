...
final case class Impressions(BidRequestId: String, PartnerId: String, SupplyVendor: String, AdWidthInPixels: Int, AdHeightInPixels: Int, DealId: String, DiscrepancyAdjustmentMultiplier: BigDecimal, FirstPriceAdjustment: BigDecimal, MediaCostCPMInUSD: BigDecimal, SubmittedBidAmountInUSD: BigDecimal, BidFeedbackId: String)
