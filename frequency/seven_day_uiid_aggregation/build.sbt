name := "seven-day-uiid-aggregation"
...
credentials += Credentials(
  ...
  "nexus.adsrvr.org",
  System.getenv("NEXUS_MAVEN_READ_USER"),
  System.getenv("NEXUS_MAVEN_READ_PASS")
)
...
assemblyJarName in assembly := "seven-day-uiid-aggregation.jar"
...
assemblyMergeStrategy in assembly := {
  ...
  case PathList("META-INF", "services", file)
      if file.startsWith("io.openlineage.client.transports.TransportBuilder") => MergeStrategy.first
