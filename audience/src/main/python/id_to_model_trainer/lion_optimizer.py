...
class Lion(tf.keras.optimizers.Optimizer):
    ...
    According to the paper, if the task is NLP, beta_1=0.95 and beta_2=0.98
        for base model (num of params <= 1B), lr=3e-4, weight_decay = 0.01;
        for large model (num of params >1B), lr = 1e-4 or 2e-4
    """
