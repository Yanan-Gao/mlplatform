...
model_features = [
    Feature(
        "SupplyVendor",
        tf.int32,
        DEFAULT_CARDINALITIES["SupplyVendor"],
        0,
    ...
    Feature(
        ...
        tf.int32,
        DEFAULT_CARDINALITIES["SupplyVendorPublisherId"],
        0,
    ...
    Feature(
        "DeviceMake",
        tf.int32,
        DEFAULT_CARDINALITIES["DeviceMake"],
        0,
    ...
    Feature(
        "DeviceModel",
        tf.int32,
        DEFAULT_CARDINALITIES["DeviceModel"],
        0,
    ...
    Feature(
        "RequestLanguages",
        tf.int32,
        DEFAULT_CARDINALITIES["RequestLanguages"],
        0,
    ...
    Feature(
        "RenderingContext",
        tf.int32,
        DEFAULT_CARDINALITIES["RenderingContext"],
        0,
    ...
    Feature(
        "DeviceType",
        tf.int32,
        DEFAULT_CARDINALITIES["DeviceType"],
        0,
    ...
    Feature(
        ...
        tf.int32,
        DEFAULT_CARDINALITIES["OperatingSystemFamily"],
        0,
...
model_dim_group = [
    Feature(
        TargetingDataIdList,
        tf.variant,
        DEFAULT_CARDINALITIES[TargetingDataIdList],
        0,
...
model_targets = [Target_(Target, tf.float32, None)]
