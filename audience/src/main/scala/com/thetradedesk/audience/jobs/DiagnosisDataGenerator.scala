  ...
  def getDiagnosisData(date: LocalDate, hour: Int): Dataset[DiagnosisRecord] = {
    ...
    auctionlog.join(adgroups, Seq("AdGroupId"), "inner")
      ...
      .agg(
        ...
        corr(col("ExpectedValue"), col("PriorityBidFactor")).as("CorrEVxPriority"),
        ...
        corr(col("ExpectedValue"), col("HmrmfpBidFactor")).as("CorrEVxHmrmfp"),
        ...
        corr(col("RelevanceScore"), col("PriorityBidFactor")).as("CorrRSMxPriority"),
        ...
        corr(col("RelevanceScore"), col("HmrmfpBidFactor")).as("CorrRSMxHmrmfp"),
        ...
        corr(col("KpiModelOutput"), col("PriorityBidFactor")).as("CorrKPIxPriority"),
        ...
        corr(col("KpiModelOutput"), col("HmrmfpBidFactor")).as("CorrKPIxHmrmfp"),
        ...
        corr(col("RValueUsed"), col("PriorityBidFactor")).as("CorrRxPriority"),
        ...
        corr(col("RValueUsed"), col("HmrmfpBidFactor")).as("CorrRxHmrmfp"),
